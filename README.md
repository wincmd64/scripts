...
### updaters/
Основная идея скриптов в этой папке – быстро обновить/установить программу прямо в её рабочей директории. Это своего рода альтернатива winget, но без регистрации приложений в системе и со своими фишками. Там, где это возможно, реализуется портативность и возможность авто-ассоциации с типами файлов. Подробности читайте в описании к каждому скрипту. Например, для Viber используя ключ `/h` можно блокировать рекламу патчем файла `hosts`.
