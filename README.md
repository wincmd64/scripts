...
### updaters/
Основная идея скриптов в этой папке – быстро обновить/установить программу прямо в её рабочей директории. Везде, где это возможно, реализуется портативность, создание ярлыка на рабочем столе и ассоциация с типами файлов. Подробности читайте в описании к каждому скрипту. Например, для Viber используя ключ `/h` можно блокировать рекламу патчем файла `hosts`.
