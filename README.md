...
Работы с видеофайлами используя [FFmpeg](https://ffmpeg.org). Умеет поворачивать, объединять, создавать .gif из видео, менять скорость, конвертировать и прочее.

>  tesseract.bat

Распознает текст из графических файлов используя [Tesseract OCR](https://github.com/UB-Mannheim/tesseract).
