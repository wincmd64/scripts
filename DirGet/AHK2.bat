...
tar -xf "%temp%\ahk-v2.zip" AutoHotkey64.exe AutoHotkey.chm
tar -xf "%temp%\ahk-v2.zip" --strip-components=1 UX/WindowSpy.ahk
if errorlevel 1 (echo. & echo  Error: extraction failed. & echo. & pause)
color A & echo. & echo. & echo  DONE. & timeout 3 & exit
