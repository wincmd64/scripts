...
reg add "HKCU\Software\Classes\*\shell\wincmd64_Hash\shell\01_SHA1\command" /ve /d "powershell.exe -NoP -C \"Get-FileHash -LiteralPath '%%1' -Algorithm SHA1 ^| Format-List ; pause\"" /f
...
reg add "HKCU\Software\Classes\*\shell\wincmd64_Hash\shell\02_SHA256\command" /ve /d "powershell.exe -NoP -C \"Get-FileHash -LiteralPath '%%1' -Algorithm SHA256 ^| Format-List ; pause\"" /f
...
reg add "HKCU\Software\Classes\*\shell\wincmd64_Hash\shell\03_SHA384\command" /ve /d "powershell.exe -NoP -C \"Get-FileHash -LiteralPath '%%1' -Algorithm SHA384 ^| Format-List ; pause\"" /f
...
reg add "HKCU\Software\Classes\*\shell\wincmd64_Hash\shell\04_SHA512\command" /ve /d "powershell.exe -NoP -C \"Get-FileHash -LiteralPath '%%1' -Algorithm SHA512 ^| Format-List ; pause\"" /f
...
reg add "HKCU\Software\Classes\*\shell\wincmd64_Hash\shell\05_MD5\command" /ve /d "powershell.exe -NoP -C \"Get-FileHash -LiteralPath '%%1' -Algorithm MD5 ^| Format-List ; pause\"" /f
